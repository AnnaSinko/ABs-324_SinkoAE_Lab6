// Lab 6.3_ABs-324 SinkoAE.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
//    vector<double> x = x0;
//    vector<double> x_new(x0.size(), 0.0);
//    double norm_diff;
//
//    do {
//        x_new = f; // Инициализация x_new
